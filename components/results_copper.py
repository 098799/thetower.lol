...
from dtower.tourney_results.constants import Graph, Options, copper
...
if __name__ == "__main__":
    ...
    df = get_tourney_result_details(TourneyResult.objects.filter(league=copper, public=True).last(), offset=0, limit=1000)
